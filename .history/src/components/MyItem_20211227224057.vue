<template>
    <li @click="handleCheck(todo.id)">
        <label>
            ...
            <input ref="editBox" @click="editClicked" type="text" v-show="edited" @keyup.enter="editCompleted(todo.id, this.value)" :value="todo.title" />
        </label>
...
export default {
    ...
    setup() {
        ...
        function editCompleted(id,title) {
            edited.value = !edited.value;
            console.log(edited.value);
